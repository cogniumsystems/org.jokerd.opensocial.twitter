 ...
 * @author kotelnikov
 */
public class TwitterActivitiesCursor
    extends
    SequentialCursor<ActivityEntry, StreamException> implements IActivityCursor {

    private static Logger log = Logger.getLogger(TwitterActivitiesCursor.class
        .getName());
    ...
    public TwitterActivitiesCursor(OAuthHelper oauthHelper) {
        fOAuthHelper = oauthHelper;
        fUrl = TWITTER_FRIENDS;
    }

    public TwitterActivitiesCursor(OAuthHelper oauthHelper, String url) {
        fOAuthHelper = oauthHelper;
        fUrl = url;
    }
